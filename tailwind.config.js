  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'card': '0 4px 24px -2px rgba(0, 0, 0, 0.12), 0 2px 8px -2px rgba(0, 0, 0, 0.08)',
        'card-hover': '0 12px 48px -4px rgba(0, 0, 0, 0.2), 0 4px 16px -4px rgba(0, 0, 0, 0.12)',
